...
public class UserInfoUtils {
    ...
    /**
     * 运营活动弹窗的时间戳(运营弹窗活动设定12小时相同条件的弹窗只弹一次)
     */
    public void setActivityTime(long activityTime) {
        editor.putLong("activityTime", activityTime);
        editor.commit();
    }

    public long getActivityTime() {
        return sp.getLong("activityTime", 0);
    }

    /**
     * 运营活动文案1(首页侧边栏kyc2和kyc3的符号旁边)
     */
    public void setActivityWord1(String activityWord1) {
        editor.putString("activityWord1", activityWord1);
        editor.commit();
    }

    public String getActivityWord1() {
        return sp.getString("activityWord1", "");
    }

    /**
     * 运营活动文案2(个人资产页面)
     */
    public void setActivityWord2(String activityWord2) {
        editor.putString("activityWord2", activityWord2);
        editor.commit();
    }

    public String getActivityWord2() {
        return sp.getString("activityWord2", "");
    }

    /**
     * 运营活动文案3(邀请好友)
     */
    public void setActivityWord3(String activityWord3) {
        editor.putString("activityWord3", activityWord3);
        editor.commit();
    }

    public String getActivityWord3() {
        return sp.getString("activityWord3", "");
    }

    /**
     * 运营活动首冲奖励
     */
    public void setFirstRecharge(float firstRecharge) {
        editor.putFloat("firstRecharge", firstRecharge);
        editor.commit();
    }

    public float getFirstRecharge() {
        return sp.getFloat("firstRecharge", 0);
    }

    /**
     * 存一下当前的版本 用于判断是否是当前版本的第一次运行
     */
