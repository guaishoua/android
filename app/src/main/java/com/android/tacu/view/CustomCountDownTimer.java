...
public class CustomCountDownTimer extends CountDownTimer {
     ...
     */
    public CustomCountDownTimer(long millisInFuture, long countDownInterval, TextView tvDisplay) {
     ...
     * @param tvDisplay      显示时间的视图
     */
    public CustomCountDownTimer(long millisInFuture, TextView tvDisplay) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        // 依次拼接时间 时:分:秒:毫秒
        tvDisplay.setText(String.format(MyApplication.getInstance().getResources().getString(R.string.auction_estimate), strLMin + ":" + strLSec + ":" + strLMs));

        if (millisInFuture - millisUntilFinished >= 1000) {
            cancel();
        }
    }
     ...
     */
    public CustomCountDownTimer setOnFinishListener(OnFinishListener onFinishListener) {
        CustomCountDownTimer.onFinishListener = onFinishListener;
        return this;
    }
