 ...
 */
public class TabLayoutView1 extends LinearLayout implements View.OnClickListener {
    ...
    public TabLayoutView1(Context context) {
        this(context, null);
    }

    public TabLayoutView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabLayoutView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        timeTitle.add(HOUR_6);
        timeTitle.add(DAY_1);
        timeTitle.add(WEEK_1);
        timeTitle.add(MONTH_1);
    }
    ...
    private void initTimePopUp() {
        ...
        timePopUp.create(UIUtils.getScreenWidth() - UIUtils.dp2px(10), UIUtils.dp2px(30), datas, new TabPopup.TabItemSelect() {
            @Override
