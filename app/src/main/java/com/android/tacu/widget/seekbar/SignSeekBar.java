...
package com.android.tacu.widget.seekbar;
...
import static com.android.tacu.widget.seekbar.SignSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.android.tacu.widget.seekbar.SignSeekBar.TextPosition.BOTTOM_SIDES;
import static com.android.tacu.widget.seekbar.SignSeekBar.TextPosition.SIDES;
...
public class SignSeekBar extends View {
    ...
    public SignSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_track_size, UIUtils.dp2px(2));
        mTextSpace = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_text_space, UIUtils.dp2px(2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_second_track_size, mTrackSize + UIUtils.dp2px(2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_thumb_radius, mSecondTrackSize + UIUtils.dp2px(2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_thumb_radius, mSecondTrackSize * 2);
        mSignBorderSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_border_size, UIUtils.dp2px(1));
        ...
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_section_text_size, UIUtils.sp2px(14));
        ...
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_thumb_text_size, UIUtils.sp2px(14));
        ...
        mSignTextSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_text_size, UIUtils.sp2px(14));
        mSignHeight = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_height, UIUtils.dp2px(32));
        mSignWidth = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_width, UIUtils.dp2px(72));
        mSignArrowHeight = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_arrow_height, UIUtils.dp2px(3));
        mSignArrowWidth = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_arrow_width, UIUtils.dp2px(5));
        mSignRound = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_round, UIUtils.dp2px(3));
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + UIUtils.dp2px(2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + UIUtils.dp2px(2);
        }
    ...
    private void drawMark(Canvas canvas, float xLeft, float yTop, boolean isShowTextBelowSectionMark, boolean conditionInterval) {
        float r = (mThumbRadiusOnDragging - UIUtils.dp2px(2)) / 2f;
