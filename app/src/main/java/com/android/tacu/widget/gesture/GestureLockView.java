package com.android.tacu.widget.gesture;
...
public class GestureLockView extends View {
    ...
    private boolean drawOuterCircle = false;
    private boolean drawArrowAfterAll = false;
     ...
     */
    private float mInnerCircleRadiusRate = 0.15F;
    ...
    public void setDrawOuterCircle(boolean drawOuterCircle) {
        this.drawOuterCircle = drawOuterCircle;
    }

    public void setDrawArrowAfterAll(boolean drawArrowAfterAll) {
        this.drawArrowAfterAll = drawArrowAfterAll;
    }
