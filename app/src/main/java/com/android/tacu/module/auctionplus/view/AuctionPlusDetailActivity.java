...
public class AuctionPlusDetailActivity extends BaseActivity<AuctionPlusPresent> implements AuctionPlusContract.IDetailView {
    ...
    void btnTradeClick() {
        EventManage.sendEvent(new BaseEvent<>(EventConstant.JumpTradeIsBuyCode, new JumpTradeCodeIsBuyEvent(Constant.TAC_CURRENCY_ID, Constant.ACU_CURRENCY_ID, Constant.TAC_CURRENCY_NAME, Constant.ACU_CURRENCY_NAME, true)));
