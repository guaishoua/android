...
public class BindingPayInfoPresenter extends BaseMvpPresenter implements BindingPayInfoContract.IPresenter {
    ...
    @Override
    public void insertBank(final Integer type, String bankName, String openBankName, String openBankAdress, String bankCard, String weChatNo, String weChatImg, String aliPayNo, String aliPayImg) {
        this.subscribeNetwork(APIServiceFactory.createAPIService(ApiHost.OTCTACU, Api.class).insertBank(type, bankName, openBankName, openBankAdress, bankCard, weChatNo, weChatImg, aliPayNo, aliPayImg), new NetDisposableObserver<BaseModel<PayInfoModel>>((IBaseMvpView) getView()) {
            @Override
