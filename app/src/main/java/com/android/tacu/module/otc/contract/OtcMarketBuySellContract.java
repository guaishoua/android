...
public class OtcMarketBuySellContract {
    ...
    public interface IView extends IBaseMvpView {
        ...
        void selectStatus(OtcMarketOrderAllModel marketModel, SelectStatusModel model);
    }
    ...
    public interface IPresenter {
        ...
        void selectStatus(OtcMarketOrderAllModel model, String merchantId, String orderId);
    }
}
