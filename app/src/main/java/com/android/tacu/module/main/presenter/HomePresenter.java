...
public class HomePresenter extends BaseMvpPresenter implements HomeContract.IPresenter {
    ...
    public void getNoticeInfo() {
        this.subscribeNetwork(APIServiceFactory.createAPIService(ApiHost.ZEN, Api.class).getNoticeInfo(1, 4, 5), new NetDisposableObserver<BaseModel<List<NoticeModel>>>((IBaseMvpView) getView(), false, false) {
            @Override
