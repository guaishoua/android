...
public class BindingInfoWxFragment extends BaseFragment<BindingPayInfoPresenter> implements BindingPayInfoContract.IWxView {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    hideLoadingView();
                    GlideUtils.disPlay(getContext(), Constant.UPLOAD_IMG_URL + imageName, img_wx_shoukuan);
    ...
    void bindingClick() {
        String weChatNo = edit_wx_name.getText().toString().trim();
    ...
    public void setValue(PayInfoModel model) {
        ...
        if (model != null) {
            ...
            GlideUtils.disPlay(getContext(), Constant.UPLOAD_IMG_URL + model.weChatImg, img_wx_shoukuan1);
        } else {
    ...
    private void uploadImgs(String fileLocalNameAddress) {
        if (!TextUtils.isEmpty(bucketName) && mOss != null) {
            // 构造上传请求
            imageName = CommonUtils.getWxImageName();
