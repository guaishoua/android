...
public class RealNamePresenter extends BaseMvpPresenter implements RealNameContract.IRealNamePresenter {
    ...
    @Override
    public void authNew(String country, String firstName, String secondName, String idNumber, String birthday, String gender, String isChina, int step, String singnTime, String outofTime, int isAllTime, Integer currentLocation) {
