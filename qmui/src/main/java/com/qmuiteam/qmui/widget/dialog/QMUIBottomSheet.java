...
public class QMUIBottomSheet extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        public BottomListSheetBuilder addItemList(List<String> textAndTagList) {
            for (int i = 0; i < textAndTagList.size(); i++) {
                mItems.add(new BottomSheetListItemData(textAndTagList.get(i), textAndTagList.get(i)));
            }
            return this;
        }
        ...
        private static class BottomSheetListItemData {
            ...
            public BottomSheetListItemData(String text, String tag, boolean isBlankShow) {
                this.text = text;
                this.tag = tag;
                this.isBlankShow = isBlankShow;
            }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    holder.blankView = convertView.findViewById(R.id.view_blank);
