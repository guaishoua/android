...
public class QMUIGroupListView extends LinearLayout {
    ...
    public QMUICommonListItemView createItemView(Drawable imageDrawable, CharSequence titleText, int height) {
        return createItemView(imageDrawable, titleText, null, QMUICommonListItemView.HORIZONTAL, QMUICommonListItemView.ACCESSORY_TYPE_NONE, height);
    }

    public QMUICommonListItemView createItemView(Drawable imageDrawable, CharSequence titleText) {
        return createItemView(imageDrawable, titleText, null, QMUICommonListItemView.HORIZONTAL, QMUICommonListItemView.ACCESSORY_TYPE_NONE);
    }
